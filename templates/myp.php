...
<div id="mask-3" class="clear-block" style="width: 1500px;">
  <div id="mask-2">
    <div id="mask-1">
        ...
        <div class="blocks clear-block">
          ...
          <div id="post-<?php the_ID(); ?>" <?php post_class('primary'); ?>>
            ...
            <div class="clear-block">
              <?php the_content(); ?>
			  <?php if(function_exists('wp_thumbnails_for_tag')) { wp_thumbnails_for_tag('id=2900&num=100&width=180&height=75&order=random'); } ?>
            </div>
      ...
      <!-- /primary content -->
      <?php atom()->t('1 column page (no sidebars)'); ?>
